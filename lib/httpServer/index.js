...
const EventsManager = require('../betcoin/eventsManager')
const BetsManager = require('../betcoin/betsManager')

class HttpServer {
  constructor (node, blockchain, operator, eventsManager, betsManager, miner, logger) {
