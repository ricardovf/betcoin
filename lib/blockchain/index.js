...
class Blockchain {
  ...
  getUnspentTransactionsForAddress (address) {
    ...
    let txOutputs = []
    R.forEach(R.pipe(R.prop('transactions'), R.filter(R.anyPass([R.propEq('type', 'regular'), R.propEq('type', 'fee'), R.propEq('type', 'reward')])), R.forEach((transaction) => {
    ...
    let txInputs = []
    R.forEach(R.pipe(R.prop('transactions'), R.filter(R.anyPass([R.propEq('type', 'regular'), R.propEq('type', 'regular'), R.propEq('type', 'regular')])), R.forEach(
