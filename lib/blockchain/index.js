...
class Blockchain {
  ...
  checkBlock (newBlock, previousBlock) {
    ...
    let regularTransactions = R.filter(R.propEq('type', 'regular'))(newBlock.transactions)
  ...
  getUnspentTransactionsForAddress (address) {
    ...
    let txOutputs = []
    R.forEach(R.pipe(R.prop('transactions'), R.filter(R.propEq('type', 'regular')), R.forEach((transaction) => {
    ...
    let txInputs = []
    R.forEach(R.pipe(R.prop('transactions'), R.filter(R.propEq('type', 'regular')), R.forEach(
