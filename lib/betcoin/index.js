...
const BetsManager = require('./betsManager')
...
class BetcoinFactory {
  constructor () {
    ...
    this.betsManager = new BetsManager(this.blockchain, this.operator, this.logger)
    this.resultsManager = new ResultsManager(this.blockchain, this.operator, this.betsManager, this.logger)
    this.miner = new Miner(this.blockchain, this.resultsManager, this.logger)
  ...
  startServer (host, port) {
    ...
    if (this.isNode()) {
      ...
      this.server = new HttpServer(this.node, this.blockchain, this.operator, this.eventsManager, this.betsManager, this.resultsManager, this.miner, this.logger)
