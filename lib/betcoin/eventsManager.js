...
Event is a transaction with type event, and the data field contains all the details of the event:
{
    ...
    "data":
    {
      "eventType" : 'soccer',
      "betType"   : 'winner',
      "eventDate" : "20/11/2017 20:00:00-3"
      "teams"     : ['Figueira', 'Avaí']
    }
}
*/
...
class EventsManager {
   ...
   * @throws
   */
  addEvent(eventType, betType, date, teams) {
    ...
    let transaction = Transaction.fromJson(tx.build())

    transaction.check()

    return this.blockchain.addTransaction(Transaction.fromJson(transaction))
  }
}
